...
const Navbar = () => {
  ...
  return (
    <div
      className="flex justify-between bg-blue-700 top-0
    ...
    >
      ...
      <div
        ...
        className={
          nav
            ? "text-black absolute left-0 top-0 w-full bg-blue-700 px-4 py-4 flex-col"
            : "absolute left-[-100%] top-0 w-full bg-gray-100/90 px-4 py-7 flex-col"
        }
      >
        <ul>
          <h2> Code With Robin's </h2>
          <li className="border-b">Home</li>
          <li className="border-b">React</li>
          <li className="border-b">Bootstrap</li>
          <li className="border-b">Ant Design</li>
          <li className="border-b">HTML / CSS</li>
